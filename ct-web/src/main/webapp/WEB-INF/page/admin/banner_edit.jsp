...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <div class="form-group">
                <label for="inputTitle">链&nbsp;接</label>
                <input type="text" class="form-control" id="inputTitle" placeholder="请输入链接">
            </div>
        </div>
    </div>
...
<form id="articleForm" action="<c:url value='/admin/banner/edit'/>" method="post">
...
<script type="text/javascript">
    ...
    $("#nav_banner").children("a").attr("href", "javascript:void(0)");
    ...
    $("#btnSubmit").click(function () {
        $("#articleForm input[name='url']").val($("#inputTitle").val());
        $("#articleForm").submit();
    });
